...
function renderLesson(id) {
  ...
  document.title = `${data.title} — AI Video Course`;
  ...
  if (data.deepDive) {
    ...
    window.addEventListener('aivideo:depth-changed', () => {
      renderDeepDive(document.getElementById('deepdive-container'), data.deepDive);
    });
  }
  ...
  window.addEventListener('aivideo:progress-synced', () => { check.checked = isComplete(id); });
  ...
  window.addEventListener('aivideo:notes-synced', () => {
