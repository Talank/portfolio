...
function renderLesson(id) {
  ...
  document.title = `${data.title} — Full-Stack Java Course`;
  ...
  window.addEventListener('java:progress-synced', () => { check.checked = isComplete(id); });
  ...
  window.addEventListener('java:notes-synced', () => {
